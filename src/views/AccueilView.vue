...
mounted() {
  ...
  data() {
    return {
      cartes: [
        { id: 1, titre: 'E-morphoz', categorie: 'éducatif', img_presentation: 'images/e-morphoz_presentation.webp' },
        { id: 2, titre: 'Usine Blender', categorie: 'personnel', img_presentation: 'images/Usine_blender.webp' },
        { id: 3, titre: 'Togethearth', categorie: 'éducatif', img_presentation: 'images/Togethearth_presentation.jpg' },
        { id: 4, titre: 'Logo MAX', categorie: 'personnel', img_presentation: 'images/Logo_MAX.webp' },
        { id: 5, titre: 'Affiche Alpha1', categorie: 'éducatif', img_presentation: 'images/Alpha1.webp' },
        { id: 6, titre: 'Site cookies', categorie: 'personnel', img_presentation: 'images/Animation_cookie.webp' },
        { id: 7, titre: 'Meat my grill', categorie: 'éducatif', img_presentation: 'images/Meat_my_grill.webp' },
        { id: 8, titre: 'MAX Blender', categorie: 'personnel', img_presentation: 'images/Blender_MAX.webp' },
        { id: 9, titre: 'Spread-night', categorie: 'éducatif', img_presentation: 'images/Spread_night.webp' },
      ],
      filtreActif: null,
