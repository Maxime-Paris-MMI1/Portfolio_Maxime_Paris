          ...
          <Header_total/>
            ...
            <div class="flex sm:flex-row xxxs:flex-col items-center justify-center mb-12 xs:mx-10 xxs:mx-5 xxxs:mx-3">
                <div class="flex flex-col">
                    <iframe width="560" height="315" class="xxxs:w-[300px] xxxs:h-[168px] xxs:w-[400px] xxs:h-[225px] xfoo:w-[560px] sm:rounded-3xl xxxs:rounded-xl xfoo:h-[315px] sm:w-[800px] sm:h-[450px] z-10" src="https://www.youtube.com/embed/CWsyTTfQQSk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <p class="text-white font-ubuntu xxxs:text-[14px] sm:text-[16px]">Music by <span class="underline"><a href="https://pixabay.com/fr/music/beats-floating-abstract-142819/" target="_blank">pixabay</a></span></p>
                </div>
                <div class="flex sm:flex-col xxxs:flex-row items-center justify-center gap-16 bg-black sm:rounded-r-2xl xxxs:rounded-b-2xl sm:rounded-l-none sm:px-5 sm:py-5 xxxs:px-8 xxxs:py-3 z-0 vers_droite vers_bas">
                    ...
                    <a href="https://www.instagram.com/p/C3S81mTskdL/" target="__blank" class="hover:scale-110 ease-in-out duration-300">
                        <img src="../../../public/images/Instagram_Glyph_White-1.webp" class="sm:w-[51px] xs:w-[40px] xxs:w-[35px] xxxs:w-[30px]" alt="logo Instagram">
                    </a>

                    <a href="https://www.behance.net/gallery/191458867/Quixhub-Headphones-branding-project?tracking_source=search_projects|quixhub&l=0" target="__blank" class="hover:scale-110 ease-in-out duration-300">
                ...
                <div class="row">
                  ...
                  mb-3">Présentation</h4>
                        ...
                        <div class=" mt-10 sm:mb-0 sm:mx-10 xxxs:mx-5 xxs:mx-7 xs:mx-9 text-white font-ubuntu xxxs:text-[14px] sm:text-[16px] hidden sm:flex sm:flex-col gap-5">    
                            <p>
                                Quixhub est un projet réalisé dans le cadre de mon dernier semestre au MMI de Montbéliard.
                                
                            </p>
                            <p>
                                L'objectif de ce projet était de concevoir quelque chose qui nous tenait à cœur et à travers lequel nous pourrions mettre en pratique les connaissances acquises au cours de notre formation. 
                            </p>
                            <p>
                                J'ai donc choisi Quixhub, une marque de casques sans fil proposant de nombreuses innovations.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                  ...
                  mb-3" id="fonctionnement">Travail effectué</h4>
                        ...
                        <div class=" sm:mb-0 sm:mx-10 xxxs:mx-5 xxs:mx-7 xs:mx-9 text-white font-ubuntu xxxs:text-[14px] sm:text-[16px] hidden sm:flex sm:flex-col">
                            ...
                            <p class="mb-5">
                                Ce projet couvre un ensemble de tâches allant de la conception des prototypes à la modélisation et à l'animation des objets.
                            </p>
...
.derriere10::before {
  content: "";
  background-image: url(../../../public/images/asteroide.webp);
  background-size: cover;
  opacity: 0.6;
  position: absolute;
