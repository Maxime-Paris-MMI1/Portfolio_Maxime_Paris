    ...
    <div class="derriere8">
        ...
        <header>
          <Header_total/>
            ...
            <div class="contenair">
                    <h1 class=" justify-center flex text-[5xl] text-white font-unbounded mt-16 mb-16 carret3 lg:-mt-[100px]">
                        <span>
                            Blender site cookie
                        </span>
                    </h1>
            ...
            <div class="flex sm:flex-row xxxs:flex-col items-center justify-center mb-12 xs:mx-10 xxs:mx-5 xxxs:mx-3">
                <div class="flex flex-col">
                    <iframe width="560" height="315" class="xxxs:w-[300px] xxxs:h-[168px] xxs:w-[400px] xxs:h-[225px] xfoo:w-[560px] sm:rounded-3xl xxxs:rounded-xl xfoo:h-[315px] sm:w-[800px] sm:h-[450px] z-10" src="https://www.youtube.com/embed/HbJ8bzlj6Wg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <p class="text-white font-ubuntu xxxs:text-[14px] sm:text-[16px]">Music by <span class="underline"><a href="https://audionautix.com" target="_blank">audionautix.com</a></span></p>
                </div>
...
.carret3:nth-child(1) span::after {
    background:#fff;
