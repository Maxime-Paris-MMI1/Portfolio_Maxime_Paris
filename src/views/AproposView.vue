...
<div class="flex justify-center my-96 py-32 text-white" style="background-image: url(../../public/images/geometry_node.png);">
  <h1>test</h1>
    ...
    <section class="mt-10 parallax" style="background-image: url(https://cdn.discordapp.com/attachments/887317553398026341/1079679313231757312/IMG_7431.jpg); background-position:center 50%; background-size: 180%;" data-speed="0.5">
